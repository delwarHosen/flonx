        ...
        <View style={styles.card}>
            ...
            <View style={styles.cardBottom}>
                <View style={styles.quantityContainer}>
                    <CustomButton onPress={() => updateQuantity(item._id, 1)} icon={<PlusIcon />} width={40} height={40} borderRadius={100} color={Colors.NEUTRAL0} />
                    <H6 color={Colors.NEUTRAL0} italic style={styles.qtyText}>{item.quantity}</H6>
                    <CustomButton onPress={() => updateQuantity(item._id, -1)} icon={<MinusIcon />} width={40} height={40} borderRadius={100} color={Colors.NEUTRAL0} />
                </View>
...
const styles = StyleSheet.create({
    ...
    headerWrapper: { paddingVertical: Platform.OS === 'ios' ? 10 : hp(16), paddingBottom: hp(20) },
    listContent: { paddingHorizontal: wp(20), paddingBottom: hp(30) },
    emptyContainer: { marginTop: hp(100), alignItems: 'center' },
    ...
    footer: {
        backgroundColor: Colors.BRAND_PRIMARY, paddingHorizontal: wp(20), paddingTop: hp(20),
