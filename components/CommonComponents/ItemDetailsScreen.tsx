...
const ItemDetailsScreen: React.FC<ItemDetailsScreenProps> = ({ checkoutPath }) => {
    const { itemName, itemImg, itemIngredients, itemPrice, itemStatus, barId, itemId } =
    ...
    const handleAddToCart = () => {
        ...
        router.push({
            ...
            params: { cartData: JSON.stringify(cartItems), barId },
        });
    };
...
const styles = StyleSheet.create({
    ...
    headerPadding: { paddingVertical: Platform.OS === 'ios' ? hp(10) : hp(16) },
    imageWrapper: { height: 280, width: '100%', justifyContent: 'center', alignItems: 'center', zIndex: 1 },
    mainImage: { width: 220, height: 220, marginTop: hp(30), borderWidth: 1, borderColor: Colors.BORDER_COLOR, borderRadius: 20 },
    infoCard: {
        flex: 1, backgroundColor: Colors.INPUT_BACKGROUND,
        borderTopLeftRadius: 50, borderTopRightRadius: 50,
        alignItems: 'center', paddingTop: Platform.OS === 'ios' ? "35%" : "30%",
        paddingHorizontal: 25, marginTop: -100, paddingBottom: 40,
    },
    title: { marginBottom: hp(6), textAlign: 'center' },
    statusBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: wp(12), paddingVertical: hp(5), borderRadius: 20, marginTop: hp(10) },
    dot: { width: 6, height: 6, borderRadius: 3, marginRight: 6 },
    quantityRow: { flexDirection: 'row', alignItems: 'center', marginTop: hp(30) },
    qtyText: { marginHorizontal: wp(20), marginTop: hp(20) },
    actionButtonContainer: { width: "100%", marginTop: hp(40), paddingBottom: Platform.OS === 'ios' ? 20 : 0 },
});