...
const Typography: React.FC<TypographyProps> = ({
    ...
    const getFontFamily = () => {
        if (italic) {
            switch (weight) {
                case "regular": return fontFamily.regularItalic;
                case "medium": return fontFamily.medium; // no italic variant
                case "semiBold": return fontFamily.semiBoldItalic;
                case "bold": return fontFamily.boldItalic;
                case "extraBold": return fontFamily.extraBold; // no italic variant
...
export const Caption4: React.FC<Omit<TypographyProps, 'variant'>> = (props) => (
    <Typography variant="caption4" weight="bold" {...props} />
);
