...
export default function CustomerCheckout() {
    return <CheckoutScreen paymentPath="/customer/items/payment-type" />;
}
...
//                 const items = Array.isArray(parsed) ? parsed : Object.entries(parsed).map(([_id, quantity]) => ({ _id, quantity }));
//                 setCartItems(items);
//                 console.log("cartData sending:", JSON.stringify(cartItems));
//             } catch (error) {
...
//                 <View style={[
//                     styles.statusBadge,
//                     { backgroundColor: item.isAvailable ? '#22C55E33' : '#EF444433' }
//                 ]}>
//                     <View style={[
//                         styles.statusDot,
