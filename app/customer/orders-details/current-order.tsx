...
// import { Dimensions, Platform, StyleSheet, View } from 'react-native'; // Dimensions & Platform add kora hoyeche
...
//                             {
//                                 backgroundColor:
//                                     step === OrderStatus.QUEUED ? '#F9731633' : '#22C55E33', 
//                             },
//                         ]}
//                     >
//                         <Ionicons
...
export default function OrderScreen() {
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#0F0B1A' }}>
            <OrderStatusContent
                orderCode="A44" 
                nextRoute="/customer/items/pickup-order" 
            />
        </SafeAreaView>
    );
}