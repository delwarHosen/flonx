...
//             label="My Profile"
//             onPress={() => router.push("/bartender/profile/my-profile")}
//           />

//           <ProfileCard
//             icon={<SettingIcon />}
//             label="Account Setting"
//             onPress={() => router.push("/bartender/profile/account-setting")}
//           />
...
//             onPress={() => router.push("/bartender/profile/term-and-condition")}
//           />

//           <ProfileCard
//             icon={<PrivecyPolicyIcon />}
//             label="Privacy policy"
//             onPress={() => router.push("/bartender/profile/privecy-policy")}
//           />

//           <ProfileCard
//             icon={<LegalCompanyInfoIcon />}
//             label="Legal & Company Info"
//             onPress={() => router.push("/bartender/profile/legal-company-info")}
//           />

//           <ProfileCard
//             icon={<HelpSupportIcon />}
//             label="Help & Support"
//             onPress={() => router.push("/bartender/profile/help-support")}
//           />
...
//             iconBG="#FFFFFF0D"
//             onPress={() => router.push("/bartender/profile/logout")}
//           />
