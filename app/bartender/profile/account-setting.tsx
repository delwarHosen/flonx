        ...
        <SafeAreaView style={styles.safeareContainer}>
            ...
            <View style={{ paddingHorizontal: "5%", marginTop:10 }}>
                <ProfileCard
                    ...
                    onPress={() => router.push("/bartender/profile/push-notification")}
                />

                <ProfileCard
                    icon={<ProfileLockIcon />}
                    label="Change Password"
                    onPress={() => router.push("/bartender/profile/change-assword")}
                />
                ...
                <ProfileCard
                    ...
                    iconBG="#FFFFFF0D"
                    onPress={() => router.push("/bartender/profile/delete-account")}
                />
            </View>
        </SafeAreaView>
    )
