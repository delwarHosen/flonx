import ItemDetailsScreen from "@/components/CommonComponents/ItemDetailsScreen";


export default function GuestItemDetails() {
    return <ItemDetailsScreen checkoutPath="/guest/checkout" />;
}
...
// import { Caption1, Caption3, H5, H6 } from '@/components/typo/Typography';
...
//                         ]} />
//                         <Caption3 color={itemStatus === 'in_stock' ? Colors.COLOR_ACTIVE : Colors.COLOR_DANGER}>
...
//         width: "100%",
//         marginTop: hp(40),
//         paddingBottom: Platform.OS === 'ios' ? hp(40) : hp(20)
//     }
// });