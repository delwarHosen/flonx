...
export const getJobs: GetJobs[] = [
    ...
    // --- ASSIGNED JOBS ---
    {
        ...
        totalAmount: 500,
        assignedOn: "05 March 2026", // যোগ করা হয়েছে
        applicants: [
            {
                id: "A3",
                name: "Sophia Miller",
    ...
    },
    {
        ...
        totalDuration: "15 hours",
        totalAmount: 375,
        appliedOn: "21 February 2026", // যোগ করা হয়েছে
        applicants: [
            {
                id: "A9",
                name: "Roberts Junior",
